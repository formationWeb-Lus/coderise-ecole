...
export default function ClientLayout({ children }: { children: React.ReactNode }) {
  ...
  const NavLinks = () => (
    <nav className="flex flex-col space-y-1 mt-3">
      <SidebarLink href="/dashboard/student" icon={<Home size={16} />}>Tableau de bord</SidebarLink>
      <SidebarLink href="/dashboard/student/courses" icon={<BookOpen size={16} />}>Mes cours</SidebarLink>
      <SidebarLink href="/dashboard/student/grades" icon={<GraduationCap size={16} />}>Notes</SidebarLink>
      ...
      <SidebarLink href="/dashboard/enrollment" icon={<ClipboardList size={16} />}>Inscriptions</SidebarLink>
      <hr className="my-2 border-blue-900" />
      <SidebarLink href="/dashboard/student/students" icon={<Users size={16} />}>Étudiants</SidebarLink>
      <SidebarLink href="/dashboard/student/help" icon={<UserCog size={16} />}>Contactez Nous</SidebarLink>
      <hr className="my-2 border-blue-900" />
      <SidebarLink href="/dashboard/profile" icon={<User size={16} />}>Profil</SidebarLink>
    </nav>
  );
